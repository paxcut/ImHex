...
namespace hex::plugin::builtin {
    ...
    void ViewPatternEditor::drawTextEditorFindReplacePopup(TextEditor *textEditor) {
        ...
        if (ImGui::BeginPopup("##text_editor_view_find_replace_popup", popupFlags)) {
            ...
            bool enter     = ImGui::IsKeyPressed(ImGuiKey_Enter, true)         || ImGui::IsKeyPressed(ImGuiKey_KeypadEnter, true);
            bool upArrow   = ImGui::IsKeyPressed(ImGuiKey_UpArrow, true)       || ImGui::IsKeyPressed(ImGuiKey_Keypad8, true);
            bool downArrow = ImGui::IsKeyPressed(ImGuiKey_DownArrow, true)     || ImGui::IsKeyPressed(ImGuiKey_Keypad2, true);
